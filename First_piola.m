function first_poila = First_piola(chi,chi_m)
%first argument is the maximum loading
%second argument is the unloading limit
%
...
for j=1:num_c
    ...
    %integral variable n is an input matrix from DD to n_max
end
